  ...
  return (
    <div className="overflow-hidden rounded-[1.5rem] border border-[#D7E3F2] bg-white shadow-[0_16px_45px_rgba(11,23,57,0.06)]">
      ...
      <div className="relative flex min-h-[520px] items-center justify-center overflow-hidden bg-[linear-gradient(135deg,#FFFFFF_0%,#F8FBFF_55%,#EAF3FF_100%)]">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full bg-[#DDEBFF]/80"
        />
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -bottom-20 left-[12%] h-44 w-[520px] rotate-[-8deg] rounded-[999px] bg-white/75"
        />
        <div
          aria-hidden="true"
          className="pointer-events-none absolute left-[18%] top-[22%] h-28 w-28 rounded-full border border-[#D7E3F2]/70"
        />
        ...
        <div className="relative px-6 text-center">
          <div className="mx-auto grid h-28 w-28 place-items-center rounded-full border border-[#CFE0F5] bg-white shadow-[0_12px_35px_rgba(22,119,255,0.10)]">
            <div className="grid h-20 w-20 place-items-center rounded-full bg-[#EAF3FF]">
              <Volume2
                className="h-10 w-10 text-[#1677FF]"
                strokeWidth={1.6}
              />
            </div>
          </div>

          <p className="mt-6 text-xs font-bold uppercase tracking-[0.2em] text-[#1677FF]">
            AI Instructor
          </p>

          <h2 className="mt-2 text-3xl font-extrabold tracking-[-0.03em] text-[#0B1739]">
            {instructorName}
          </h2>
