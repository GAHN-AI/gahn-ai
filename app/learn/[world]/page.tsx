    ...
    categories: [
      {
        ...
        description:
          "Explore business careers and learn how companies are created, financed, marketed, operated, and grown.",
        topics: [
          "Entrepreneur",
      ...
      },
      {
        ...
        description:
          "Explore modern technology careers and build the practical knowledge each path requires.",
        topics: [
          "Software Engineer",
          "Web Developer",
          "Frontend Developer",
      ...
      },
      {
        ...
        description:
          "Build the practical skills used across jobs, companies, leadership roles, and professional environments.",
        topics: [
          "Communication",
          "Public Speaking",
          "Negotiation",
      ...
      },
      {
        ...
        description:
          "Explore careers and learn what the work, education, skills, responsibilities, and career path actually look like.",
        topics: [
          "Doctor",
          "Nurse",
          "Pharmacist",
