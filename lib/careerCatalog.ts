...
export const careerSections: CareerSection[] = [
  {
    ...
    lessons: [
      { title: "Software Engineer", description: "Programming, systems thinking, debugging, and software development." },
      { title: "Web Developer", description: "Build websites and web applications with modern frontend and backend tools." },
      { title: "AI Engineer", description: "Learn AI systems, model integration, prompting, evaluation, and AI products." },
      { title: "Machine Learning Engineer", description: "Train, evaluate, and deploy machine-learning systems." },
      { title: "Cybersecurity Analyst", description: "Protect systems, networks, accounts, and data from security threats." },
      { title: "Data Scientist", description: "Use data, statistics, coding, and models to answer important questions." },
      { title: "Data Analyst", description: "Analyze data, create reports, and communicate useful business insights." },
      { title: "Cloud Engineer", description: "Build and maintain cloud infrastructure, services, and deployments." },
      { title: "DevOps Engineer", description: "Automate software delivery, infrastructure, monitoring, and reliability." },
      { title: "UX / Product Designer", description: "Design digital products around user needs, research, and usability." },
      { title: "IT Support Specialist", description: "Troubleshoot devices, software, networks, and workplace technology." },
      { title: "Solutions Architect", description: "Design complete technical solutions for complex business needs." },
    ],
  },
  {
